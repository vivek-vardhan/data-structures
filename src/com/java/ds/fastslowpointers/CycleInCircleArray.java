...
public class CycleInCircleArray {
    ...
    The cycle should have more than one element and should follow one direction which means the cycle should not contain both forward and backward
    ...
    public static boolean loopExists(int[] arr) {
        for (int i = 0; i < arr.length; i++) {
            boolean isForward = arr[i] >= 0; // if we are moving forward or not : If direction change, it will not come in cycle as per question
